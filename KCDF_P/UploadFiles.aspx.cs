...
namespace KCDF_P
{
    public partial class UploadFiles : System.Web.UI.Page
    {
        ...
        protected void UploadFile(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((ext == ".jpeg") || (ext == ".jpg") || (ext == ".png") || (ext == ".pdf") || (ext == ".docx") || (ext == ".doc") || (ext == ".xlsx"))
                {
                    ...
                    loadUploads();
                    KCDFAlert.ShowAlert("Document: " + filename + " uploaded successfully");
                   
                }
                else
                {
                    KCDFAlert.ShowAlert("File Format is: " + ext + ": - Allowed picture formats are: JPG, JPEG, PNG, PDF, DOCX, DOC only!");
        ...
        protected void loadUploads()
        {
            try
            {
                string[] filePaths = Directory.GetFiles(Server.MapPath("~/Uploaded Documents/" + Students.No + "/"));
        ...
        protected void saveAttachment(string filName, string extension)
        {
            ...
            string fullFPath = Request.PhysicalApplicationPath + "All Uploads\\" + Students.No + "\\" + filName;
          ...
          //  sup.FnAttachment(usNo, docType, fullFPath, filName, granttype);
